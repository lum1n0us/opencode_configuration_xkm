...
- **Full preprocessor simulation**: Tracks macro definitions, evaluates conditions, handles nested `#if` blocks
...
├── macro_analyzer/
│   ├── __init__.py
│   ├── expression.py    # Expression parser and evaluator
│   ├── symbols.py       # Symbol table management
│   ├── processor.py     # File processor and condition stack
